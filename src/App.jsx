...
// ---------------------------------------
  ...
  function handleseatclick(seatNumber, setPopupData , setShowPopup){
    const reservedseat= rs.find((item)=> item.st ===seatNumber)
if(reservedseat){
  setPopupData(reservedseat);
  setShowPopup(true);
}else{
  setrs(`Seat ${seatNumber} is available`)
}  }
...
<Route path='/status' element={<Status rs={rs} handleseatclick={handleseatclick} closePopup={closePopup}/>}/>
</Route>
